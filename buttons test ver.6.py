...
# # Кнопка для копирования зашифрованного сообщения
# copy_encrypt_button = ttk.Button(root, text="Cope encrypted message", command=lambda: copy_text(ciphertext_entry))
# copy_encrypt_button.pack()

# # Кнопка для копирования дешифрованного сообщения
# copy_decrypt_button = ttk.Button(root, text="Copy decrypted message", command=lambda: copy_text(plaintext_label))
# copy_decrypt_button.pack()
